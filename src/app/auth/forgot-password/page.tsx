                        ...
                        <div className="space-y-1">
                            <div className="relative group">
                                <input
                                    type="email"
                                    {...register("email")}
                                    className="w-full h-14 bg-slate-950/50 border border-slate-800 rounded-2xl px-4 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] text-left"
