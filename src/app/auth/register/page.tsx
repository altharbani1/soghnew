                        ...
                        <div className="space-y-1">
                            <div className="relative group">
                                ...
                                <input
                                    type="text"
                                    {...register("name")}
                                    className="w-full h-12 bg-slate-950/50 border border-slate-800 rounded-2xl px-12 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] text-sm"
                        ...
                        <div className="space-y-1">
                            <div className="relative group">
                                ...
                                <input
                                    type="email"
                                    {...register("email")}
                                    className="w-full h-12 bg-slate-950/50 border border-slate-800 rounded-2xl px-12 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] text-sm text-left"
                            ...
                            <div className="space-y-1">
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        {...register("password")}
                                        className="w-full h-12 bg-slate-950/50 border border-slate-800 rounded-2xl px-12 text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] text-sm font-sans tracking-widest"
                                        placeholder="••••••••"
                                    />
