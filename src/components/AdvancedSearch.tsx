...
export default function AdvancedSearch() {
    ...
    useEffect(() => {
        const searchTimer = setTimeout(async () => {
            ...
            setIsLoading(true);
            try {
                const res = await fetch(`/api/ads?search=${encodeURIComponent(query)}&limit=8`);
                if (res.ok) {
        ...
        <div className="relative w-full" ref={resultsRef}>
            <div className="relative">
                ...
                <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 p-2 text-[var(--foreground-muted)] hover:text-[var(--primary)]"
                >
